...
import com.quispe.lab10.data.SerieApiService
import retrofit2.Retrofit
import retrofit2.converter.gson.GsonConverterFactory

@Composable
fun SeriesApp() {
    val urlBase = "http://192.168.1.2:8000/" // o tu IP si usarás un dispositivo externo
...
fun ScreenInicio() {
    Column(
        ...
        Text("¡Bienvenido a Series App!", fontSize = 24.sp, fontWeight = FontWeight.Bold)
